...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'router_plan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kiki/catkin_ws/install/${idir}'.  Ask the maintainer 'kiki <kiki@todo.todo>' to fix it.")
    endif()
